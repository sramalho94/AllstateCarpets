...
const About = () => {
  return (
    ...
    <h1 className="font-bold text-center max-w-lg text-[#80241b] pt-10 md:pl-16">Specialty</h1>
    ...
    <br></br>
    <h1 className="font-bold text-center max-w-lg text-[#80241b] pt-3 md:pl-16">About Allstate</h1>
    <p className="text-center max-w-lg text-[#ac1010] md:pl-16">
